...
public class GazePlotter : MonoBehaviour
{
	...
	private Vector3 Smoothify(Vector3 point)
	{
		...
		var smoothedPoint = new Vector3(
			point.x * (1.0f - FilterSmoothingFactor) -0.03f+ _historicPoint.x * FilterSmoothingFactor,
			point.y * (1.0f - FilterSmoothingFactor) -0.03f + _historicPoint.y * FilterSmoothingFactor,
